...
class HairMultilayerRepairedModel : public FazzyModel
{

public:
	HairMultilayerRepairedModel(std::shared_ptr<TYPE::Field> f);
...
class HairMultilayerRepairedLargeDisPerlinModel : public FazzyModel
{

public:
	HairMultilayerRepairedLargeDisPerlinModel(std::shared_ptr<TYPE::Field> f);
	string mkdir(string root) override;
	double calcEPS(const double&, const double&, enum INTEG = D_XY) override;
	double calcSIG(const double&, const double&, const double lam, enum INTEG = D_XY) override;
	bool update(int) override {
